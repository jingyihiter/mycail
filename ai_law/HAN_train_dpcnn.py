...
tf.app.flags.DEFINE_string("ckpt_dir_accu","./checkpoint_dpcnn_big/checkpoint_accu/","checkpoint location for the model") 
tf.app.flags.DEFINE_string("ckpt_dir_law","./checkpoint_dpcnn_big/checkpoint_law/","checkpoint location for the model") 
tf.app.flags.DEFINE_string("ckpt_dir_imprision","./checkpoint_dpcnn_big/checkpoint_imprision/","checkpoint location for the model") 

tf.app.flags.DEFINE_string("log_path", "./ai_law_dpcnn.log", "log path location")
