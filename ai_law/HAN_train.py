...
tf.app.flags.DEFINE_string("ckpt_dir","./ad_param/dropout_keep_0.6/checkpoint/","checkpoint location for the model") #save to here, so make it easy to upload for test
tf.app.flags.DEFINE_string("ckpt_dir_dpcnn","./predictor/checkpoint_dpcnn_big32/","checkpoint location for the dpcnn model")
tf.app.flags.DEFINE_string("log_path", "./predictor/ai_law.log", "log path location")
...
tf.app.flags.DEFINE_float("keep_dropout_rate", 0.6, "percentage to keep when using dropout.") #0.65一次衰减多少
