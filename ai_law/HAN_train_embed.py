...
tf.app.flags.DEFINE_string("ckpt_dir","./checkpoint_newembed/checkpoint/","checkpoint location for the model") #save to here, so make it easy to upload for test
tf.app.flags.DEFINE_string("ckpt_dir_dpcnn","./predictor/checkpoint_dpcnn_big32/","checkpoint location for the dpcnn model")
tf.app.flags.DEFINE_string("log_path", "./newembed_ai_law.log", "log path location")
...
tf.app.flags.DEFINE_string("word2vec_model_path","data/big.data.bin","word2vec's vocabulary and vectors") #data_big/law_fasttext_model100.bin-->
