...
tf.app.flags.DEFINE_string("traning_data_file","./../big_data/pre_cail2018_big.json","path of traning data.")
...
tf.app.flags.DEFINE_string("ckpt_dir","./checkpoint_dpcnn_big/checkpoint/","checkpoint location for the model") #save to here, so make it easy to upload for test

tf.app.flags.DEFINE_string("ckpt_dir_accu","./all_data/textcnn_final/checkpoint_accu/","checkpoint location for the model") 
tf.app.flags.DEFINE_string("ckpt_dir_law","./all_data/textcnn_final/checkpoint_law/","checkpoint location for the model") 
tf.app.flags.DEFINE_string("ckpt_dir_imprision","./all_data/textcnn_final/checkpoint_imprision/","checkpoint location for the model") 

tf.app.flags.DEFINE_string("log_path", "./ai_law_textcnn_all.log", "log path location")
